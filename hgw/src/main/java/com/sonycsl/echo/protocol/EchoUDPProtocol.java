...
public class EchoUDPProtocol extends EchoProtocol {
    ...
    public void openUDP() throws IOException {
        ...
        mSocketAddress = new InetSocketAddress(mMulticastAddress, PORT);

        nwif = EchoUtils.getNetworkInterface();

        mMulticastSocket.setNetworkInterface(this.nwif);
        mMulticastSocket.joinGroup(mSocketAddress, this.nwif);
        mMulticastSocket.setOption(StandardSocketOptions.IP_MULTICAST_LOOP, false);
    ...
    public void closeUDP() {
        ...
        if (mMulticastSocket != null) {
            try {
                mMulticastSocket.leaveGroup(mSocketAddress, this.nwif);
            } catch (IOException e) {
                e.printStackTrace();
            }
